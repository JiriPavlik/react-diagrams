...
export declare class DiagramEngine extends CanvasEngine<CanvasEngineListener, DiagramModel> {
    ...
    getNodeFactories(): FactoryBank<AbstractReactFactory<NodeModel<import("./entities/node/NodeModel").NodeModelGenerics>, DiagramEngine>, import("../../react-canvas-core").FactoryBankListener<AbstractReactFactory<NodeModel<import("./entities/node/NodeModel").NodeModelGenerics>, DiagramEngine>>>;
    getLinkFactories(): FactoryBank<AbstractReactFactory<LinkModel<import("./entities/link/LinkModel").LinkModelGenerics>, DiagramEngine>, import("../../react-canvas-core").FactoryBankListener<AbstractReactFactory<LinkModel<import("./entities/link/LinkModel").LinkModelGenerics>, DiagramEngine>>>;
    getLabelFactories(): FactoryBank<AbstractReactFactory<LabelModel<import("./entities/label/LabelModel").LabelModelGenerics>, DiagramEngine>, import("../../react-canvas-core").FactoryBankListener<AbstractReactFactory<LabelModel<import("./entities/label/LabelModel").LabelModelGenerics>, DiagramEngine>>>;
    getPortFactories(): FactoryBank<AbstractModelFactory<PortModel<import("./entities/port/PortModel").PortModelGenerics>, DiagramEngine>, import("../../react-canvas-core").FactoryBankListener<AbstractModelFactory<PortModel<import("./entities/port/PortModel").PortModelGenerics>, DiagramEngine>>>;
